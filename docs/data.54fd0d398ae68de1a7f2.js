...
var isDataOutdated = function () {
    return __WEBPACK_IMPORTED_MODULE_0_localforage___default.a.getItem(lastUpdateKey).then(function (data) {
        lastUpdate = data;
        return __webpack_require__.e/* import() */(1).then(__webpack_require__.bind(null, 31)).then(data => {
...
var init = function () {
    ...
    switch (currentLang) {
        case "ja-JP": {
            __webpack_require__.e/* import() */(4).then(__webpack_require__.bind(null, 22));
            break;
        }
        case "zh-TW": {
            __webpack_require__.e/* import() */(2).then(__webpack_require__.bind(null, 23));
            break;
        }
        case "en-US": {
            __webpack_require__.e/* import() */(5).then(__webpack_require__.bind(null, 24));
            break;
        }
        case "zh-CN": {
            __webpack_require__.e/* import() */(3).then(__webpack_require__.bind(null, 25));
            break;
        }
    }
};
